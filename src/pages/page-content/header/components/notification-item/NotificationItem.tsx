...
import {
    NotificationState
} from "./components/notifications/components/notifications-list/components/notification/Notification.types"
...
function NotificationItem({ notifications }: NotificationItemProps) {
    ...
    return (
        <div className={notificationItemCSS.notificationItem}>
            ...
            <Popup isPopupShown={isNotificationsPopupShown} onOutsideClickPopupClose={() => setIsNotificationsPopupShown(false)}>
