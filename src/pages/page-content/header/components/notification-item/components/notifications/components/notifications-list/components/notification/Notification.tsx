...
function Notification({ notification }: NotificationProps) {
  ...
  return (
    <div
      className={`${notificationCSS.notification} ${notification.state === NotificationState.READ ? notificationCSS.read : notificationCSS.unread}`}
    >
      <div
        className={`${
          notification.user.photo ? notificationCSS.circle : `${notificationCSS.initialsCircle} ${notificationCSS[initialsCircleColor]}`
        }`}
      >
