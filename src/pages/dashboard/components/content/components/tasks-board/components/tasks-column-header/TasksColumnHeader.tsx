  ...
  return (
    ...
    >
      ...
      {category !== 'completedTasks' && (
        <Button size={ButtonSize.SMALL} type={ButtonType.PRIMARY} onClick={() => null} additionalClasses={tasksColumnHeaderCSS.addNewButton}>
          <Svg path={plusIcon} width="16" height="11" viewBox="0 0 13 12" color={SvgColors.WHITE} />
        </Button>
      )}
    </motion.div>
  );
