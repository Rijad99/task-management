// CSS 
import taskAttachmentsCSS from './TaskNotes.module.scss'
...
function TaskNotes() {
    ...
    return (
        <Button size={ButtonSize.SMALLEST} type={ButtonType.PRIMARY} onClick={() => null}>
            ...
            <span className={taskAttachmentsCSS.number}>3</span>
        </Button>
    )
}
