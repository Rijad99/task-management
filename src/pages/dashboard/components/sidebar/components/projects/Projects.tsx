...
// ENUMS
import { ButtonSize, ButtonType } from '../../../../../../common/components/button/Button.types.ts';
...
function Projects({ onProjectChange }: ProjectsProps) {
  ...
  return (
    <Accordion title={localization.projects}>
      <Button type={ButtonType.PRIMARY} size={ButtonSize.LARGE} onClick={handleProjectCreation} additionalClasses={projectsCSS.createProjectButton}>
        {localization.createNewProject}
        <Svg path={plusIcon} width="26" height="13" viewBox="0 0 9 14" color={SvgColors.NEUTRAL} />
      </Button>
