...
function Participants({ participants }: TaskParticipantsProps) {
  ...
  return (
    <div className={taskParticipantsCSS.participants}>
      ...
      {restOfParticipantsNumber !== 0 && <div className={taskParticipantsCSS.restOfParticipants}>{`+${restOfParticipantsNumber}`}</div>}
      <Tooltip
        text={localization.addParticipant}
        position={TooltipPosition.TOP}
        tooltipContainerClasses={taskParticipantsCSS.addParticipantTooltipContainer}
        tooltipClasses={taskParticipantsCSS.addParticipantTooltip}
      >
