...
export const userStatusData: DropdownItem[] = [
	{
		...
		icon: (
			<div
				className={`${userStatusCSS.circle} ${userStatusCSS.green} ${utilsCSS.mr05}`}
			></div>
		),
	},
	{
		...
		icon: (
			<div
				className={`${userStatusCSS.circle} ${userStatusCSS.gray} ${utilsCSS.mr05}`}
			></div>
		),
	},
	{
		...
		icon: (
			<div
				className={`${userStatusCSS.circle} ${userStatusCSS.orange} ${utilsCSS.mr05}`}
			></div>
		),
	},
	{
		...
		icon: (
			<div
				className={`${userStatusCSS.circle} ${userStatusCSS.red} ${utilsCSS.mr05}`}
			></div>
		),
	},
	{
	...
	},
	{
		...
		icon: (
			<div
				className={`${userStatusCSS.circle} ${userStatusCSS.purple} ${utilsCSS.mr05}`}
			></div>
		),
	},
]
